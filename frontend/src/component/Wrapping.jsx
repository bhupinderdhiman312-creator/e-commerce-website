...
import dottedpaper from "../assets/dottedpaper.avif";
import diamondpaper from "../assets/diamondpaper.avif";
import planpaper from "../assets/planpaper.avif";
...
<div className='h-30 w-full flex flex-col-reverse justify-center items-center bg-gray-200'>
      ...
      <p className='font-extrabold text-3xl'> Wrapping Papers   </p>
   </div>
    <div className='h-120 w-full flex border-t-2 bg-gray-200'>
         ...
         <div className='h-120 w-fit grid grid-cols-3 items-center justify-evenly bg-gray-200'>
          ...
          <img src={ dottedpaper } alt="" className='h-100 w-100'/>
          <p className='font-medium bg-black text-white flex items-center h-10'> Doted Wrapping paper </p>
        </div>
        <div className='h-110 w-100 ml-8 hover:scale-103 shadow-lg'>
          <img src={ diamondpaper } alt="" className='h-100 w-100'/>
          <p className='font-medium bg-black text-white flex items-center h-10'> Diamond Wrapping paper </p>
        </div>
        <div className='h-110 w-100 ml-8 hover:scale-103 shadow-lg'>
          <img src={ planpaper } alt="" className='h-100 w-100'/>
          <p className='font-medium bg-black text-white flex items-center h-10'> Striped Wrapping paper </p>
          </div>                   
         </div>
         </div>
